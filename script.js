...
player.innerHTML = ` <h3>🎵 ${songTitle}</h3> <p>${artist}</p>

```
<p>
  Select a music service to listen to the full song.
</p>

<div class="music-buttons">

  <a
    href="https://open.spotify.com/search/${encodeURIComponent(songTitle + " " + artist)}"
    target="_blank"
  ...
  <a
    href="https://music.youtube.com/search?q=${encodeURIComponent(songTitle + " " + artist)}"
    target="_blank"
    rel="noopener noreferrer"
    class="listen-service-button"
  >
